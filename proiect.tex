...
R5=FULL OUTER JOIN(R2, R4, id_firma)
...
R9=SELECT(ANGAJAT, tip_angajat = 'SOFER' and to_char(data_angajare, 'dd-mm-yyyy') < '13-9-2020')
R10=PROJECT(R9, id_angajat, nume, prenume, salariu)
R11=PROJECT(PERMIS, id_angajat)
R12=JOIN(R10, R11, count(p.id_angajat) >= 1)
R13=PROJECT(R12, id_angajat, nume, prenume, salariu)
R14=FULL OUTER JOIN(R8, R13, id_angajat)
R15=SELECT(FIRMA, tip_firma='TRANSPORT')
R16=PROJECT(id_firma, nume)
R17=FULL OUTER JOIN(R14, R16, id_firma)
